    ...
    <div className="w-full">
      <div className="px-6 py-5 border-b border-gray-200 bg-white flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex flex-col sm:flex-row gap-2">
          <button className="bg-emerald-50 hover:bg-emerald-100 text-emerald-700 font-bold text-[11px] px-3 py-2 rounded-lg shadow-sm border border-emerald-200 flex items-center justify-center gap-2 transition">
            <Upload className="w-3 h-3" /> Import Excel
          </button>
          <button className="bg-slate-50 hover:bg-slate-100 text-slate-700 font-bold text-[11px] px-3 py-2 rounded-lg shadow-sm border border-gray-200 flex items-center justify-center gap-2 transition">
            <Download className="w-3 h-3" /> Template Excel
          </button>
          <button onClick={() => setIsAddingMode(!isAddingMode)} className="self-start sm:self-center bg-indigo-600 hover:bg-indigo-700 text-white font-bold text-[11px] px-4 py-2 rounded-lg shadow-sm flex items-center justify-center gap-2 transition">
